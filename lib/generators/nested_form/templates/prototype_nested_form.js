document.observe('click', function(e, el) {
    ...
    var collection = el.readAttribute('data-collection');
	  var content    = $(assoc + '_fields_blueprint').down('.fields').up().innerHTML; // Fields template
    ...
    if (collection) {
      $('collection' + collection).insert(content)
    }
    else {
